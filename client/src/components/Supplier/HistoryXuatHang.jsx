...
const HistoryXuatHang = () => {
  ...
  const data = [
    { idNhapHang: 2, sanPhamId: 19, soLuong: 100, ngayTao: '2024-12-27 21:45:4', trangThai: 'Đã xác nhận', ghiChu: 'Sản phẩm phải chát lượng' },
    { idNhapHang: 3, sanPhamId: 20, soLuong: 100, ngayTao: '2024-12-28 21:45:4', trangThai: 'Đã xác nhận', ghiChu: 'Sản phẩm phải chát lượng' }
  ]
      ...
      <Table
        title={() => (
          <div className="flex justify-between">
            <div>
              <Title level={3}>Lịch sử xuất hàng</Title>
            </div>
          </div>
        )}
        loading={isLoading}
...
export default HistoryXuatHang