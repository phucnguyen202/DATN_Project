            ...
            <form action="#" onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="flex flex-col mb-6">
                ...
                <div className="relative">
                  ...
                  <input type="password" {...register("password")} className="text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400" placeholder="Password" />
                </div>
                {/* <p className='text-sm text-red-600'>
